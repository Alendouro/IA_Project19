...
public class PanelParameters extends PanelAtributesValue {
    ...
    String[] recombinationMethods = {"PMX", "Order 1 Crossover", "Cycle Crossover"};
    ...
    String[] mutationMethods = {"Insert", "Swap Mutation", "Inversion Mutation"};
    ...
    public Recombination<CatchIndividual, CatchProblemForGA> getRecombinationMethod() {
        ...
        switch (comboBoxRecombinationMethods.getSelectedIndex()) {
            ...
            case 1:
                return new RecombinationOrder1Crossover<>(recombinationProb);
            case 2:
